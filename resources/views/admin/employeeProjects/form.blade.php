			   	...
			   	<div class="col-lg-12">
		           	<div class="border border-3 p-4 rounded">
						<div class="mb-3">
			                ...
			                <!-- {!! Form::text('task_name', null, array('id'=>'task_name','value' => '$task->task_name', 'required'=>'required', 'class' => 'form-control '.$errorClass )) !!}
						...
						<div id="TextBoxDiv1">
							...
							<div class="row">
								...
								@if(count($task->feature_list_one) > 0)
						        @for($i = 0; $i < count($task->feature_list_one); $i++)

									<input type="text" class="form-control" name="feature_list_one" value="{{$task->feature_list_one[$i]}}" readonly >			
									@endfor
							     @endif
								</div>
									<div class="col-sm mb-3">
									@if(count($task->feature_list_two) > 0)
						        @for($i = 0; $i < count($task->feature_list_two); $i++)
									<input type="text" class="form-control" name="feature_list_two" value="{{$task->feature_list_two[$i]}}" readonly>
									@endfor
							     @endif
									</div>
									<div class="col-sm mb-3">
									@if(count($task->feature_list_three) > 0)
						        @for($i = 0; $i < count($task->feature_list_three); $i++)
									<input type="text" class="form-control" name="feature_list_three" value="{{$task->feature_list_three[$i]}}" readonly>
									@endfor
							     @endif
									</div>
									<div class="col-sm mb-3">
									@if(count($task->feature_list_four) > 0)
						        @for($i = 0; $i < count($task->feature_list_four); $i++)
									<input type="text" class="form-control" name="feature_list_four" value="{{$task->feature_list_four[$i]}}" readonly>
									@endfor
							     @endif
									</div>
									<div class="col-sm mb-3">
									@if(count($task->feature_list_five) > 0)
						        @for($i = 0; $i < count($task->feature_list_five); $i++)
									<input type="text" class="form-control" name="feature_list_five" value="{{$task->feature_list_five[$i]}}" readonly>
									@endfor
							     @endif
									</div>
						...
						<div class="mb-3">
							...
							<textarea type="textarea" class="form-control ckeditor" name="feature_list_five" value="" readonly> 
							  {{$task->srs}}
							</textarea>
						...
						<div id="TextBoxDiv1">
							...
							<div class="row">
								...
								<div class="mb-3">
								@if(count($task->test_cases) > 0)
						        @for($i = 0; $i < count($task->test_cases); $i++)
								<input type="text" class="form-control" name="test_cases" value="{{$task->test_cases[$i]}}" readonly>
                        ...
                        <div class="mb-3">
	                        ...
	                        <div class="form-group input-group">
	                            	...
	                            	<div id="image_preview"><img id="previewing" src="{{$task->image}}" readonly></div>
	                            ...
	                            <!-- <div class="form-control" onclick="document.getElementById('file').click()">
	                                ...
	                                <input type="file" id="file" name="image[]" style="visibility:hidden;" class="form-control" multiple>
	                            </div> -->
	                         </div>
	                    </div>
                        <!-- <div class="mb-3">
