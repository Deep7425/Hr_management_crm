...
<style>
  ...
  <li class="nav-item" role="presentation">
   <a href="{{url('admin/enquiry')}}"> <button class="nav-link" type="button" role="tab">Inbox</button></a>
  </li>
  <li class="nav-item" role="presentation">
   <a href="{{url('admin/enquiry/archive')}}"> <button class="nav-link active" type="button" role="tab">Archive</button></a>
  </li>
</ul>
...
var tables = $('#datatable').DataTable({
	...
	retrieve: true,
	"ajax": {
		url: "{{ customeRoute($page.'.archiveIndex') }}",
		data: function (d) {
			return $.extend({}, d, {
...
<script>
      ...
      if(response){
        ...
        $.ajax({
          ...
          data: {'id':id},
          dataType:'json',
          url: "{{url('admin/archiveRemoveToIndex')}}",
          success:function(){
