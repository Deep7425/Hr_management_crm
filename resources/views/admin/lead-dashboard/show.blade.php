...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">View Archive deatils</div>
            <div class="ps-3">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            ...
                            <tr><th>Telephone</th><td>{{$data->mobile_number}}</td></tr>
                            <tr><th>IP Address</th><td>{{$data->ipaddress}}</td></tr>
                            <tr><th>Country Location</th><td>{{$data->country_location}}</td></tr>
                            <tr><th>Country</th><td>{{$data->country}}</td></tr>
                            <tr><th>Amount</th><td>{{$data->business_amount}}</td></tr>
                            <tr><th>Comment</th><td>{{$data->qualified_comment}}</td></tr>
