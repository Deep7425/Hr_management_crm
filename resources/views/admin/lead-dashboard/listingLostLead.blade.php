...
<style>
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Lost Lead Dashboard</li>
							</ol>
						</nav>
					</div>
					<!-- <div class="ms-auto">
  ...
  <li class="nav-item" role="presentation">
   <a href="{{url('admin/lead-dashboard/lost-lead')}}"> <button class="nav-link active" type="button" role="tab">Lost Leads</button></a>
  </li>
...
var tables = $('#datatable').DataTable({
	...
	retrieve: true,
	"ajax": {
		url: "{{ customeRoute($page.'.lostLeadIndex') }}",
		data: function (d) {
			return $.extend({}, d, {
