...
<style>
  ...
  white-space: unset; 
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Archive Data</li>
							</ol>
						</nav>
					</div>
   ...
   <a href="{{url('admin/lead-dashboard')}}"> <button class="nav-link active" type="button" role="tab">Archive Leads</button></a>
  </li>
						<li class="nav-item" role="presentation">
