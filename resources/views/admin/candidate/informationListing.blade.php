...
@section('content')
					...
					<div class="card-header">
		                <div class="row">
		                    ...
		                    <div class="col-md-4 d-inline-flex mt-2">
                                <a href="{{customeRoute($page.'.informationcreate',['candidate_id'=>$candidate_id])}}" class="btn btn-primary me-3"><i class="bx bx-plus"></i>Add Document</a> 
                                </div>
        ...
        <div class="table-responsive">
								...
								<thead class="table-light">
									<tr>
										<th>School/University/Certification Name</th>
										<th>Passout Year</th>
                                        <th>Percentage</th>
										<th>Create at</th>
										<th>Actions</th>
	...
	<script type="text/javascript">
		...
		var tables = $('#datatable').DataTable({
            ...
            retrieve: true,
            "ajax": {
                url: "{{ customeRoute($page.'.informationListing') }}",
                data: function (d) {
