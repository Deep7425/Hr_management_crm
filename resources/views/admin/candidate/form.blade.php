			   	...
			   	<div class="col-lg-12">
		           	<div class="border border-3 p-4 rounded">
						...
						<div class="mb-3">
			                ...
			                {!! Form::email('email', null, array('id'=>isset($data->email)?true:false,'placeholder' => 'Email Address', 'required'=>'required', 'class' => 'form-control '.$errorClass)) !!}
						...
						<div class="mb-3">
							<label for="inputlastCompany" class="form-label">Last Company</label>
							<?php  $errorClass =  !empty($errors->has('lastCompany')) ? 'is-invalid':''; ?>   
			                {!! Form::text('lastCompany', null, array('id'=>'lastCompany','placeholder' => 'Enter Last Company', 'class' => 'form-control '.$errorClass )) !!}
			                {!! !empty($errors->has('lastCompany')) ?'<div class="invalid-feedback"><span>'.$errors->first('lastCompany').'</span></div>' :'' !!}
						</div>
						...
						<div class="mb-3">
							...
							<?php  $errorClass =  !empty($errors->has('remark')) ? 'is-invalid':''; ?>   
			                {!! Form::text('remark', null, array('id'=>'remark','placeholder' => 'Enter remark', 'class' => 'form-control '.$errorClass )) !!}
			                {!! !empty($errors->has('remark')) ?'<div class="invalid-feedback"><span>'.$errors->first('remark').'</span></div>' :'' !!}
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
			                ...
			                {!! Form::text('linkedIn_URL', null, array('id'=>'linkedIn_URL','placeholder' => 'Enter linkedIn URL' ,'class' => 'form-control linkedIn_URL'.$errorClass )) !!}
						...
						<div class="mb-3">
			                ...
			                {!! Form::select('notice_period',['immediate join' => 'Immediate join', '15 days' => '15 days', '30 days' => '30 days','45 days'=>'45 days','60 days'=>'60 days','90 days'=>'90 days'], null, array('id'=>'notice_period','placeholder' => 'Select Notice Period','class' => 'form-control '.$errorClass )) !!}
			                {!! !empty($errors->has('notice_period')) ?'<div class="invalid-feedback"><span>'.$errors->first('notice_period').'</span></div>' :'' !!}
						</div>
						<div class="mb-3">
							<label for="inputName" class="form-label">About us</label>
							<?php  $errorClass =  !empty($errors->has('about_us')) ? 'is-invalid':''; ?>   
			                {!! Form::textarea('about_us', null, array('id'=>'about_us','class' => 'form-control '.$errorClass )) !!}
			                {!! !empty($errors->has('about_us')) ?'<div class="invalid-feedback"><span>'.$errors->first('about_us').'</span></div>' :'' !!}
						</div>
			            <div class="mb-3">
						    <div class="d-grid">
...
$(".linkedIn_URL").change(function () {      
var inputvalues = $(this).val();      
  var regex = /(^((https?:\/\/)?((www|\w\w)\.)?)linkedin\.com\/)((([\w]{2,3})?)|([^\/]+\/(([\w|\d-&#?=])+\/?){1,}))$/;    
