...
@section('content')
					...
					<div class="card-header">
		                <div class="row">
		                    ...
		                    <div class="col-md-4 d-inline-flex mt-2">
                                <a href="{{customeRoute($page.'.taskcreate',['project_id'=>$project_id])}}" class="btn btn-primary me-3"><i class="bx bx-plus"></i>Add Task</a> 
                                </div>
        ...
        <div class="table-responsive">
								...
								<thead class="table-light">
									<tr>
										<th>Task Name</th>
										<th>feature list one</th>
                                        <th>feature list Two</th>
                                        <th>feature list Three</th>
                                        <th>feature list Four</th>
										<th>SRS</th>
										<th>Test Cases</th>
										<th>Create at</th>
										<th>Actions</th>
	...
	<script type="text/javascript">
		...
		var tables = $('#datatable').DataTable({
            ...
            "aoColumns": [
                //{mData: 'id'},
                {mData: 'task_name'},
                {mData: 'feature_list_one'},
                {mData: 'feature_list_two'},
                {mData: 'feature_list_three'},
                {mData: 'feature_list_four'},
				{mData: 'srs'},
				{mData: 'test_cases'},
                {mData: 'created_at'},
                {mData: 'actions'}
