            ...
            <div class="row">
                ...
                <div class="border border-3 p-4 rounded">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="inputproject_award_date" class="form-label required">Project Award
                                    Date</label>
                                <?php  $errorClass =  !empty($errors->has('project_award_date')) ? 'is-invalid':''; ?>
                                {!! Form::text('project_award_date', null,
                                array('id'=>'project_award_date','placeholder' => 'Enter Date', 'required'=>'required',
                                'readonly', 'class' => 'start_date form-control '.$errorClass )) !!}
                            ...
                            <div class="mb-3">
                                <label for="inputdocument_url" class="form-label required">Document URL</label>
                                <?php  $errorClass =  !empty($errors->has('document_url')) ? 'is-invalid':''; ?>
                                {!! Form::text('document_url', null, array('id'=>'document_url','placeholder' => 'Enter document url', 'required'=>'required', 'class' => 'form-control '.$errorClass )) !!}
                                {!! !empty($errors->has('document_url')) ?'<div class="invalid-feedback">
                                    <span>'.$errors->first('document_url').'</span>
                                </div>' :'' !!}
                                <div class="mb-3">
                                    <!-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            {!! Form::text('currency',null, array('id'=>'currency','placeholder' => 'Enter Currency','class' => 'form-control'.$errorClass )) !!}
                                        ...
                                        <div class="col-md-9 mb-3">
                                            ...
                                            <label for="inputtotal_amount" class="form-label required">Total
                                                Amount</label>
                                            <?php  $errorClass =  !empty($errors->has('total_amount')) ? 'is-invalid':''; ?>
                                            {!! Form::text('total_amount', null, array('onkeypress'=>'return
                                            event.charCode == 46 || (event.charCode >= 48 && event.charCode <=
                                                57)','id'=>'total_amount','placeholder' => 'Enter Total Amount','id'=>'pointspossible', 'required'=>'required', 'class' =>
                                                'form-control '.$errorClass )) !!}
                                                {!! !empty($errors->has('total_amount')) ?'<div
                                ...
                                {!! !empty($errors->has('due_amount')) ?'<div class="invalid-feedback">
                                    <span>'.$errors->first('due_amount').'</span>
                                </div>' :'' !!}
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-1"><button type="button" id='addButton'
                                                    class="btn btn-primary btn-xs" style="color:white;">+</button></div>
                    ...
                    <script src="{{ URL::asset('assets/plugins/Drag-And-Drop/dist/imageuploadify.min.js')}}">
                    </script>
                    ...
                    $(document).ready(function() {
                        ...
                        $("#addButton").click(function() {
                            ...
                            newTextBoxDiv.after().html('<br/><div class="row appendAttrDiv_' +
                                ...
                                counter +
                                '" value="" ></div><div class="col-sm-2 mb-3"><input type="text" class="form-control due_dates attr_name_en" placeholder="Please select due date" required="required" name="due_date[]" id="due_date_' +
                                counter +
                                '" value="" readonly></div><a onclick="removeAttributeField(' +
                                counter +
                                ')" title="Remove" class="btn btn-primary btn-xs">x</a></div>'
                            );
