					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Technology Manager</li>
							</ol>
						</nav>
					</div>
					...
					<div class="card-header">
		                <div class="row">
		                    ...
		                    <div class="col-md-6 d-inline-flex mt-2">
                                ...
                                <a href="{{customeRoute($page.'.create')}}" class="btn btn-primary me-3"><i class="bx bx-plus"></i> Add Technology</a>                                
		                    </div>                
		                </div>
		            </div>         
					<div class="card-body">
