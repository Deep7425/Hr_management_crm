...
class EmployeeProjectController extends Controller
{
     ...
     */
    protected  $page = 'employeeProjects';
    protected  $table;

    public function __construct() {
        $this->middleware('auth');
        $this->Models = new EmployeeProject(); 
    ...
    {   
        ...
        //$project_emp['project'] = Project::where('projects','like',"%{$team_member}%")->get();
        ...
        return view('admin.employeeProjects.listing', $data);
    ...
    public function show($id)
    {
        ...
        return view('admin.employeeProjects.show')->with('data',$data);
    }
    ...
    public function employeeTask($id)
    {
        ...
        $task_details = Task::where('project_id',$id)->get();
         
         //dd($task_details);
        
        // $data['task'] = $task_details;
       
        $json = json_encode(array('id'=>$id));
        $data= ['task'=>$task_details]; 
        // dd($data);
        return view('admin.employeeProjects.employeeTask',$data);
    }
    ...
    public function taskView($id){
        ...
        //dd($data);
        $data['feature_list_one'] = explode(',',$data->feature_list_one);
        $data['feature_list_two'] = explode(',',$data->feature_list_two);
        $data['feature_list_three'] = explode(',',$data->feature_list_three);
        $data['feature_list_four'] = explode(',',$data->feature_list_four);
        $data['feature_list_five'] = explode(',',$data->feature_list_five);
        $data['test_cases'] = explode(',',$data->test_cases);
        //dd($data);
         //dd($data);
        ...
        return view('admin.employeeProjects.taskView',$data);
    }
    /**
    ...
    //         unset($input['_token']);
    //         $data->update($input);
    //         return Redirect::route('admin.hradmin.index')->with('success',"Record updated successfully.");
